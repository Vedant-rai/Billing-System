                ...
                {   system("clear");
                    printf("\n\n\t\tcorrect username and password\n\n");
                        ...
                        switch(opt)
                        {
                            ...
                            {
                                fp=fopen("RestaurantBill.dat","a+"); // a+ for creating the file
                            ...
                            case 2:
                            system("clear");
                            if(fp =fopen("RestaurantBill.dat","r"))
                            ...
                            fp1 = fopen("tempbill.dat","w");     //temporary file to store data
                            found=0;
